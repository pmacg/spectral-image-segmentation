...
def parse_args():
    ...
    parser.add_argument('inputFilename', type=str, help="the filename of the image to be segmented")
    parser.add_argument('outputFilename', type=str, help="the name of the file to save the segmented image to")
    parser.add_argument('numSegments', type=int, help="the number of segments to find in the image")
